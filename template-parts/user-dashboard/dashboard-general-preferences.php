...
$language_settings = \STA\Inc\UserDashboard::get_language_settings($user_id);
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-lg-7 col-xxl-8">
                ...
                <h3 class="mb-35"><?php _e('General Preferences', 'sta'); ?></h3>

                <!-- invitations form -->
                <div class="sta-user-details py-40 form-active">
                    <h4 class="mb-40"><?php _e('Language', 'sta'); ?></h4>
                    <div class="sta-user-details-form">
                        <?php get_template_part('template-parts/user-dashboard/parts/form-language', '', [
