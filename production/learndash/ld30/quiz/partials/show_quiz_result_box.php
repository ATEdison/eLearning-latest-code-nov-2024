...
<div class="sta-quiz-results mb-40"></div>
...
<div style="display: none;" class="wpProQuiz_results">
        ...
        echo wp_kses_post(
            SFWD_LMS::get_template(
                ...
                array(
                    ...
                    'message' => '<p class="wpProQuiz_answered_correctly">' . sprintf(esc_html_x('%1$s of %2$s %3$s answered correctly', 'placeholder: correct answer, question count, questions', 'learndash'), '<span class="wpProQuiz_correct_answer">0</span>', '<span>' . $question_count . '</span>', learndash_get_custom_label('questions')) . '</p>',
    ...
    <div class="ld-quiz-actions" style="margin: 10px 0px;">
        ...
        <?php if (!$quiz->isBtnRestartQuizHidden()) { ?>
            <a href="<?php echo esc_url(add_query_arg(['restart_quiz' => $quiz_post_id])); ?>" class="wpProQuiz_button wpProQuiz_button_restartQuiz" type="button">
                <?php
