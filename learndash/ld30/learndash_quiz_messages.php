 ...
 *
 * Available Variables:
 * @var int $quiz_post_id : (integer) Current Quiz Post ID being display.
 * @var string $context : A unique label to distunquish the message and is used below to match the message to the optional replacement message.
 * @var string $message : This is the message to be displayed. THIS MUST BE RETURNED
 * @var array $placeholders : Array of placeholder values used in message. If used by $message. $placeholders[0] is first placeholder value, $placeholders[1] second etc.
 *
 * @since 2.4
 *
