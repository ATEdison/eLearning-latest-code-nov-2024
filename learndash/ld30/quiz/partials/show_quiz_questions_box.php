		...
		foreach ( $quiz_view->question as $question ) {
			...
			<li class="wpProQuiz_listItem" style="display: none;" data-type="<?php echo esc_attr( $question->getAnswerType() ); ?>" data-question-meta="<?php echo htmlspecialchars( wp_json_encode( $question_meta ) ); ?>">
				...
				<div class="wpProQuiz_question" style="margin: 10px 0px 0px 0px;">
				    <div class="h4 nn-question-index"><?php printf('Question %1$s of %2$s', $index, $question_count); ?></div>
							...
							foreach ( $answer_array as $v_idx => $v ) {
								...
								<li class="wpProQuiz_questionListItem" data-pos="<?php echo esc_attr( $datapos ); ?>">
									...
									if ( $question->getAnswerType() === 'single' || $question->getAnswerType() === 'multiple' ) {
                                        ...
                                        // sta
                                        get_template_part('learndash/ld30/quiz/partials/sta-quiz-matching-row', '', [
                                            'msacw_value' => $msacw_value,
				...
				<div class="sta-quiz-navigation">
			        <input type="button" name="back" value="<?php _e('Back', 'learndash'); ?>" class="wpProQuiz_button wpProQuiz_QuestionButton sta-quiz-navigation-back">
                    <input type="button" name="next" value="<?php _e('Next', 'learndash'); ?>" class="wpProQuiz_button wpProQuiz_QuestionButton sta-quiz-navigation-next" style="display: none;">
			    </div>
